...
\is{AdjP|see {adjective, adjective phrase (AdjP)}}
\is{adjectival phrase|see {adjective, adjective phrase (AdjP)}}
...
\is{objective case|see {accusative case}}
\is{possessive case|see {genitive case}}
...
\is{fused-head construction|see {fused relative}}
\is{gerund|see {gerund-participial}}
\is{helping verb|see {auxiliary verb}}
\is{infinitive|see {infinitival}}
\is{modal verb|see {modal auxiliary verb}}
\is{negative concord|seealso{negation, double negation}}
\is{double negatives|see {negation, double negation}}
\is{multiple negation|see {negation, double negation}}
\is{non-restrictive clause|see {clause, supplement}}
\is{tree diagram|see {syntax tree}}
\is{one, cardinal|see {numeral}}
\is{passive voice|see {passive}}
\is{past perfect|see {aspect, perfect}}
\is{perfect tense|see {aspect, perfect}}
\is{plain present tense|see {plain present form}}
\is{PP|see {preposition, preposition phrase (PP)}}
\is{possessive adjective/pronoun|see {determiner, possessive}}
\is{present perfect|see {aspect, perfect}}
\is{reduced relative|seealso{relative clause}}
\is{scope of negation|seealso{negation}}
\is{to-infinitive|see {infinitival}}
\is{tough construction|see {extraposition}}
...
\is{gonna@\textit{gonna}|see {connected speech, contraction, reduction}}
\is{wanna@\textit{wanna}|see {connected speech, contraction, reduction}}
