...
\begin{tcolorbox}[title=Check Your Understanding: Given-New Flow, colback=yellow!10!white, colframe=orange!75!black]
...
\begin{tcolorbox}[title=Practice: Topic-Focus Analysis, colback=yellow!10!white, colframe=orange!75!black]
...
You may have been told that you should avoid the passive, but no matter how many times you've heard such thing, I think you'll agree that (a) is much better than (b).
\is{end-weight|)}
...
This chapter examined information packaging as a crucial aspect of effective communication, exploring how speakers strategically arrange information to guide listener attention:

\begin{itemize}[noitemsep]
    \item \textbf{Information packaging principle}: How we structure and present information is as important as what we say, affecting comprehension and emphasis through strategic arrangement
    \item \textbf{Given--new ordering}: Information typically flows from familiar/known elements to new/important elements, creating natural discourse progression and processing ease
    \item \textbf{Topic--focus structure}: Topics (what sentences are about) usually appear early and represent given information, while focus (newsworthy elements) appears later as new information
    \item \textbf{Cleft constructions}: \emph{It}-clefts and \emph{wh}-clefts allow speakers to highlight specific elements by restructuring sentences around focus elements
    \item \textbf{Passive voice functions}: Passives serve information packaging by topicalizing patients/recipients while backgrounding or omitting agents, not just stylistic variation
    \item \textbf{Fronting strategies}: Moving elements to sentence-initial position can establish topics or create special emphasis effects
    \item \textbf{Extraposition patterns}: Moving ``heavy" clausal subjects to sentence-final position improves processing by following end-weight principles
    \item \textbf{Discourse context dependence}: Effective information packaging requires understanding what listeners already know and what needs emphasis in specific communicative situations
\end{itemize}

Understanding information packaging helps teachers explain why certain sentence structures feel more natural than others and guides students in making strategic choices that enhance clarity and effectiveness in their own communication.
