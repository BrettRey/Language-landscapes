...
\begin{tcolorbox}[title=Discourse analysis tools in this chapter, colback=gray!10!white, colframe=gray!75!black]
This chapter introduces several analytical tools for understanding information structure:
\begin{itemize}[noitemsep]
    \item \textbf{Given-New Analysis} -- Identifying what information is already known vs. newly introduced in discourse
    \item \textbf{Topic-Focus Structure} -- Distinguishing what a sentence is about (topic) from what new information is provided (focus)
    \item \textbf{Cleft Construction Analysis} -- Understanding how \emph{it}-clefts and \emph{wh}-clefts highlight specific elements
    \item \textbf{Information Weight Principles} -- Examining how ``heavy'' constituents tend to appear later in sentences
    \item \textbf{Active-Passive Alternation} -- Analyzing how voice choice affects information flow and participant prominence
\end{itemize}
These tools help teachers understand why certain sentence structures feel more natural than others in specific discourse contexts.
\end{tcolorbox}
...
\begin{itemize}[noitemsep]
    ...
    \item \textbf{Teaching implications}: Helping students understand information packaging improves both comprehension and production by making discourse structure explicit
\end{itemize}
