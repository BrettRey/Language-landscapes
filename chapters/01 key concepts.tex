...
\begin{tblsframedsymbol}{Learning Objectives}{bulb}
  ...
  \begin{itemize}[noitemsep]
      ...
      \item Distinguish between everyday and technical meanings of grammatical terms
      ...
      \item Recognize how words can belong to multiple categories depending on context
...
5. What's the thinking trap we should try to avoid?
\end{tblsframedsymbol}
...
3. C) is correct. The category of verbs can't be reliably defined based on denotations.
...
\ea[]{\gll \emph{J'} \emph{ai} \emph{coupé} \emph{mes} \emph{cheveux}.\\
