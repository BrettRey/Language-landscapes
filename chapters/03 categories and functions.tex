...
\begin{itemize}[noitemsep]
    \item \textit{[\emph{my} mother's] sister}~-- \mention{my} is Det in \textit{my mother's}; \textit{my mother's} is Det in \textit{my mother's sister}
    \item \textit{[\emph{the} dog's] owner}~-- \mention{the} is Det in \textit{the dog's}; \textit{the dog's} is Det in \textit{the dog's owner}
    \item \textit{[\emph{this} morning's] headlines}~-- \mention{this} is Det in \textit{this morning's}; \textit{this morning's} is Det in \textit{this morning's headlines}
\end{itemize>
