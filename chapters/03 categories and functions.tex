...
\begin{itemize}[noitemsep]
    ...
    \item Complements are ``selected'' by a head \\(e.g., \textit{listen \emph{to the music}} not \textit{*listen \emph{about the music}}; \textit{listen} selects a \textit{to} PP.).
