...
\begin{enumerate}[noitemsep, leftmargin=*]
    ...
    \item \textit{Normative} statements are those about how language \enquote{ought} to be used based on established conventions or standards, rather than describing how it is actually used.
