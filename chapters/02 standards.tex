...
\label{ex:quitter}
\z
Like (\ref{ex:weekend}), (\ref{ex:quitter}) is not \enquote{wrong} but rather an example of a dialectal difference. It may not be grammatical in Standard English, but it is in other varieties.
