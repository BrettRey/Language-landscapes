...
\begin{tcolorbox}[title=What's a shibboleth\is{shibboleth|(}?, breakable, colback=white] \label{sec:shibboleth}
...
\begin{tcolorbox}[title=The fallacy of monosemy\is{fallacy of monosemy|(}, breakable, colback=white] \label{sec:fallacy-of-monosemy}\is{monosemy}
...
\begin{tcolorbox}[title=Essay Questions, breakable, colback=white]
