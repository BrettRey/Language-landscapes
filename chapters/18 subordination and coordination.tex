...
\ea \label{ex:content-funcs}
    \ea[]{\textit{I \uline{suspect} {\ob}that he left{\cb}.}\hfill[\textsc{verb complement}]}
    \ex[]{\textit{The \uline{fact} {\ob}that he left{\cb} is clear.}\hfill[\textsc{noun complement}]}
    \ex[]{\textit{I'm \uline{glad} {\ob}that he left{\cb}.}\hfill[\textsc{adjective complement}]}
    \ex[]{\textit{We can proceed \uline{provided} {\ob}that he left{\cb}.}\hfill[\textsc{preposition complement}]}
