...
\begin{itemize}[noitemsep]
    ...
    \item Explain \textit{do}-support rules for basic interrogatives lacking auxiliary verbs
    \item Analyze focused interrogatives and their interrogative phrases (\textit{who}, \textit{what time}, \textit{where}, \textit{how often}, etc.)
...
\begin{itemize}[noitemsep]
    ...
    \item \textbf{Plain form test} -- Use \textit{be} vs \textit{is} in \textit{do}-support constructions to verify verb forms
...
\setlength{\parindent}{1.5em}
    ...
    (\ref{ex:finding-subjects2}a) also lacks any agreement signals about the subject. But in the basic interrogative in (\ref{ex:finding-subjects2}b), \textit{could} is in front of \textit{you}, which means that \textit{Tuesday} \uline{can't} be the subject; it must be \textit{you}.
