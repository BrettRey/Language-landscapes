...
\begin{tcolorbox}[title=Quick Analysis: Lexical Chains, colback=yellow!10!white, colframe=orange!75!black]
...
\begin{tcolorbox}[title=``Use complete sentences'', breakable, colback=white, colframe=blue!75!black, fonttitle=\bfseries]\label{sec:complete-sentences}
...
\begin{tcolorbox}[title=Understanding Bridging: Try This, colback=yellow!10!white, colframe=orange!75!black]
...
This chapter examined how texts achieve unity and flow through coherence and cohesion, exploring the mechanisms that make discourse hang together across sentences:

\begin{itemize}[noitemsep]
    \item \textbf{Coherence vs. cohesion distinction}: Coherence involves logical and semantic connections between ideas, while cohesion refers to specific linguistic devices that signal these connections
    \item \textbf{Topic chain management}: Effective discourse maintains topic continuity through strategic use of pronouns, lexical repetition, and inference, avoiding both choppy repetition and unclear reference
    \item \textbf{Lexical cohesion patterns}: Words and phrases are repeated, varied, and semantically related across texts to create multi-layered chains that guide readers through complex ideas
    \item \textbf{Cohesive device repertoire}: English uses pronouns, ellipsis, conjunctive relations, and lexical ties to create explicit links between text elements
    \item \textbf{Abductive bridging mechanisms}: Readers create coherence by inferring unstated connections through knowledge of typical scenarios, drawing on frames like restaurant-waiter or baking-oven relationships
    \item \textbf{Inference and implicature}: What goes unsaid often contributes more to coherence than explicit markers, requiring readers to actively construct meaning from textual gaps
    \item \textbf{Cross-linguistic variation}: Languages differ in specific cohesive strategies (ellipsis vs. pronouns, morphological vs. lexical marking) while sharing universal discourse principles
    \item \textbf{Pedagogical applications}: Teaching coherence and cohesion involves analyzing authentic texts, exploring first language transfer, and developing intuitions for how devices work together
    \item \textbf{Beyond mechanical rules}: Effective discourse instruction moves beyond isolated grammar exercises to examine how cohesive patterns serve meaningful communication in context
\end{itemize}

Understanding coherence and cohesion helps teachers explain why some texts feel unified and flowing while others seem disjointed, providing tools for improving both reading comprehension and writing instruction.

\is{cohesion|)}\is{coherence|)}

\begin{tcolorbox}[title=Exercise: Short-Answer Questions, breakable, colback=white, colframe=blue!75!black, fonttitle=\bfseries]
...
\begin{tcolorbox}[title=Answer, breakable, colback=white, colframe=blue!75!black, fonttitle=\bfseries]
...
\end{enumerate}
\end{tcolorbox}
\begin{tcolorbox}[title=Essay questions, breakable, colback=white, colframe=blue!75!black, fonttitle=\bfseries]
\begin{enumerate}[noitemsep]
