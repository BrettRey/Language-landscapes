...
\begin{tcolorbox}[title=Discourse analysis techniques in this chapter, colback=gray!10!white, colframe=gray!75!black]
This chapter introduces several tools for analyzing how texts achieve unity and flow:
\begin{itemize}[noitemsep]
    \item \textbf{Topic Chain Analysis} -- Tracking how topics are introduced, maintained, and developed across sentences
    \item \textbf{Cohesive Device Mapping} -- Identifying pronouns, lexical repetition, and conjunctive markers that link text elements
    \item \textbf{Inference Pattern Recognition} -- Understanding how readers fill gaps through logical and pragmatic reasoning
    \item \textbf{Abductive Bridging Analysis} -- Examining how readers create connections between seemingly unrelated text elements
    \item \textbf{Coherence vs. Cohesion Distinction} -- Separating surface-level linguistic links from deeper logical connections
\end{itemize}
These techniques help teachers understand why some texts feel unified and flowing while others seem disjointed or confusing.
\end{tcolorbox}
