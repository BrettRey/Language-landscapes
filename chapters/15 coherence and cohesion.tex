...
Discourse rarely gets much attention in teacher training, so it's not surprising that some common classroom directives sit awkwardly with how discourse actually works. Take the familiar instruction to ``use complete sentences.''

\phantom{~~~~}The intention behind this directive is clear: teachers want students to produce grammatically well-formed output, especially at lower levels. But the directive can misfire, because in natural communication, ``complete sentences'' are often neither necessary nor appropriate. Consider a typical conversation:
