...
\ea
    \ea[]{[At home, near an open window] \emph{It's cold.}\hfill[Request to close window]}
    \ex[]{[Tasting soup] \emph{It's cold.}\hfill[Complaint about food]}
    \ex[]{[At the bus stop] \emph{It's cold.}\hfill[Just making conversation]}
    \z
\z
...
\ea
   \ea[]{[Asked \emph{How did you get here?}]\\ \emph{I placed one foot in front of the other, repeatedly transferring my weight from the back foot to the front foot, while maintaining my balance and adjusting my trajectory as needed to avoid obstacles and ensure arrival at my intended destination.}\hfill[too much information]}
   \ex[]{[About a student's excuse] \\\emph{Yes, and I'm the Queen of England.}\hfill[not true]}
   \ex[]{[Asked if they liked the gift] \\\emph{Well, it's Thursday today.}\hfill[not relevant]}
   \z
\z
...
\ea
   \textbf{A:} \emph{How was the movie?}\\
   \textbf{B:} \emph{Well, the popcorn was good.}
\z
...
\ea
   \textbf{A:} \emph{Did you get my email?}\\
   \textbf{B:} \emph{My laptop died.}\\
   \textbf{A:} \emph{So you need me to send it again?}\\
   \textbf{B:} \emph{No, I saw it on my phone. I'll respond tonight.}
\z
...
\ea
   \textbf{A:} \emph{Coffee?}\\
   \textbf{B:} \emph{I've had five cups already.}\\
   \textbf{A:} \emph{Tea then?}\\
   \textbf{B:} \emph{Water's fine.}
\z
