...
\begin{tcolorbox}[title=Reflection: Your Learning Strategy, colback=blue!10!white, colframe=blue!75!black]
Consider your own learning preferences. Which of the four benefits of syntax trees (dual-encoding, brevity/clarity, explicitness, practice with feedback) resonates most with you? How might understanding these benefits help you explain grammatical concepts to your students, even if you don't use trees directly in class?
\end{tcolorbox}
...
Apply the constituency tests to this sentence: \textit{The teacher explained the difficult concept clearly}. Test whether \textit{the difficult concept} is a constituent by trying: (1) Coordination: "...explained \underline{the difficult concept} and \underline{the easy one}", (2) Pro-form replacement: "...explained \underline{it}", (3) Can it be moved to the front?, (4) Can it be omitted in ellipsis?
\end{tcolorbox}
\is{constituency tests|)}
...
Before continuing, ensure you can confidently: Read a syntax tree from bottom to top; Identify heads and dependents in any phrase; Explain why we use function labels; Apply at least two constituency tests; Use the seven-point checklist to verify tree accuracy. If you cannot confidently do all of these, review the relevant sections.
\end{tcolorbox}
\is{syntax tree!well-formedness checks|)}
...
\begin{itemize}[noitemsep]
    ...
    \item \textbf{Teacher preparation tool}: While not shown directly to students, trees help teachers understand complex structures they need to explain and troubleshoot
    \item \textbf{Systematic methodology}: Tree notation provides consistent, principled methods for analyzing any English construction, from simple to complex
