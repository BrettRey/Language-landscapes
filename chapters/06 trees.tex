...
Before continuing, ensure you can confidently: ☐ Read a syntax tree from bottom to top, ☐ Identify heads and dependents in any phrase, ☐ Explain why we use function labels, ☐ Apply at least two constituency tests, ☐ Use the seven-point checklist to verify tree accuracy. If any boxes remain unchecked, review the relevant sections.
\end{tcolorbox}
\is{syntax tree!well-formedness checks|)}
