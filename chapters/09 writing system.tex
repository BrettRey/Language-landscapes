...
\begin{tcolorbox}[title=Cross-linguistic Perspective, colback=green!10!white, colframe=green!75!black]
Consider your students' backgrounds: A student literate in Arabic (consonantal), Japanese (syllabic + logographic), or Chinese (logographic) brings different literacy skills to English. How might their writing system experience affect their phonemic awareness and approach to English spelling patterns?
\end{tcolorbox}
...
\begin{tcolorbox}[title=Practical Balance: Decoding vs Meaning, colback=green!10!white, colframe=green!75!black]
How do you avoid the ``barking at print'' problem while still addressing decoding needs? What ratio of decoding practice to meaningful reading works for your students? How do you recognize when a student has achieved sufficient decoding automaticity to focus more on comprehension?
\end{tcolorbox}
...
\begin{itemize}[noitemsep]
    ...
    \item \textbf{Phonics limitations}: While phonics helps with decoding, English's irregularities mean that whole-word recognition and contextual strategies are also essential for fluent reading
    ...
    \item \textbf{Adult learner challenges}: Many adults struggle with decoding due to different L1 writing systems, undiagnosed reading disabilities, or gaps in phonological awareness
    ...
    \item \textbf{Reading vs. listening}: While cognitively similar, reading offers learner control but lacks contextual cues, requiring different instructional approaches
