...
\begin{enumerate}[noitemsep]
    ...
    \item The reason the double-u looks like two ⟨v⟩s instead of two ⟨u⟩s is that initially the vowel was written with the sharp shape ⟨v⟩ and the consonant as the rounded ⟨u⟩. While they switched places in Middle English, the ``sharp u'' continued to be used for ⟨w⟩.
\end{enumerate}
...
But the digital revolution has shaken up the spelling world. Now we have AI assistants taking our spoken words and turning them into text. Our phones and computers finish our words for us and fix our typos on the fly. Web browsers and word processors underline our mistakes and offer one-click fixes.
