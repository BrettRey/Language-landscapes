...
\section{Why English spelling looks the way it does}\is{spelling!history of|(}
...
\subsection{The evolution of English orthography}
...
\subsubsection{From runes to Roman letters}
...
\subsubsection{The Norman Conquest and the Great Vowel Shift}\label{sec:great-vowel-shift}
...
\begin{itemize}[noitemsep]
    \item \mention{bite}: Middle English /biː.tə/ → Modern English /baɪt/
    \item \mention{name}: Middle English /naː.mə/ → Modern English /neɪm/
    \item \mention{rose}: Middle English /rɔː.zə/ → Modern English /roʊz/
\end{itemize}
...
\begin{figure}
    ...
    \small License: \url{https://creativecommons.org/licenses/by-sa/4.0}
\end{figure}
