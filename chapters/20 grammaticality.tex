...
This chapter introduces frameworks for understanding grammatical acceptability:
\begin{itemize}[noitemsep]
    \item \textbf{Gradient Acceptability Assessment} -- Evaluating grammaticality on a continuum rather than binary judgment
    \item \textbf{Form-Meaning Pairing Analysis} -- Understanding how constructions link structural patterns with semantic/pragmatic content
    \item \textbf{Community Convention Mapping} -- Identifying which speech communities accept particular grammatical patterns
    \item \textbf{Multi-factor Judgment} -- Considering syntax, semantics, pragmatics, and social meaning in acceptability decisions
    \item \textbf{Processing Constraint Analysis} -- Understanding how cognitive limitations affect grammatical performance
\end{itemize}
These analytical tools reveal grammaticality as a complex phenomenon involving community norms, cognitive constraints, and communicative effectiveness rather than absolute rules.
\end{tcolorbox}
...
\begin{itemize}[noitemsep]
    \item \textit{*Can the have running} -- What type of ungrammaticality is this and why?
...
\begin{itemize}[noitemsep]
    ...
    \item \textbf{Form-meaning pairing foundation}: Grammatical constructions are conventional mappings between linguistic forms and semantic/pragmatic meanings within specific communities
    \item \textbf{Community convention dependence}: Grammaticality standards vary across speech communities, dialects, registers, and social contexts -- what's ungrammatical in one may be standard in another
    \item \textbf{Multi-dimensional meaning}: Constructions encode truth-conditional semantics, pragmatic meaning (politeness, formality), social meaning (dialect marking), and discourse functions
    \item \textbf{Three ungrammaticality types}: Meaningless forms (no interpretable content), meaning misalignments (form-meaning mismatch), and unmotivated non-standard forms (lacking pragmatic justification)
    \item \textbf{Processing limitation effects}: False negatives (garden-path sentences judged ungrammatical) and false positives (ungrammatical structures accepted due to processing overload)
...
Understanding grammaticality requires analyzing multiple interacting factors -- syntactic structure, semantic coherence, pragmatic appropriateness, social meaning, processing constraints, and community norms -- rather than applying prescriptive rules divorced from communicative context.
