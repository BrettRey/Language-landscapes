...
\begin{itemize}[noitemsep]
    ...
    \item Identify polysemy, collocations, and formulaic language in English vocabulary
...
\paragraph*{Verb-forming suffixes} These suffixes change words into verbs. For example, to describe somebody's character is to \mention{characterize} them. The verb \mention{characterize} is formed by adding the verb-forming suffix \mention{-ize} to the noun \mention{character}. The most common verb-forming suffixes, occurring in roughly 20--170 verbs each, are: \mention{-ize}/\mention{-ise}, \mention{-en}, \mention{-ate}, and \mention{-}(\mention{i})\mention{fy}.

\paragraph*{Verb-changing prefixes} These prefixes change the meaning of the verb without changing its lexical category. For example, if you \mention{overdo} something, you do it too much. But both \mention{do} and \mention{overdo} are verbs. The most common of these prefixes are: \mention{re-}, \mention{over-}, \mention{un-}, \mention{mis-}, and \mention{out-} \citep[400]{Biber1999}.

\paragraph*{Noun-forming suffixes} These suffixes change adjectives and verbs into nouns. For example, \mention{openness} is the adjective \mention{open} + the suffix \mention{-ness}. The most productive are: \mention{-tion}, \mention{-ism}, \mention{-ity}, \mention{-ness}, \mention{-ment}, \mention{-ant}, \mention{-ship}, \mention{-age}, and \mention{-ery}.
...
3. A student writes: \enquote{I looked it up in the dictionary but couldn't find \textit{happily}.} 
...
2. \textit{The} appears about 60,800 times per million words, while \textit{purchase} appears three orders of magnitude less frequently.
 \begin{enumerate}[nosep]
...
3. Compare these two sentences: \textit{I need to make a decision} and \textit{I need to decide.} Since both convey essentially the same meaning, what does the existence of two forms tell us about the nature of English vocabulary?
\end{tblsframedsymbol}
...
1. A textbook presents these words together in a unit on \enquote{emotions}: \textit{happy}, \textit{sad}, \textit{angry}, \textit{frustrated}, \textit{elated}, \textit{melancholy}.
  \begin{enumerate}[nosep]
...
3. \textbf{The linguistics of \enquote{knowing a word}}
