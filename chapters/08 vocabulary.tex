...
\begin{tcolorbox}[title=Reflection: Rethinking Vocabulary Instruction, colback=blue!10!white, colframe=blue!75!black]
After reading about frequency distributions and common pitfalls, how might you change your approach to vocabulary teaching? What would you prioritize instead of semantic sets, rare idioms, or low-frequency words? How can morphological knowledge provide more teaching leverage?
\end{tcolorbox}
...
Before concluding, check your understanding: Can you explain the difference between word families and lemmas? Do you understand why frequency follows a Zipfian distribution? Can you identify morphological processes in unfamiliar words? Do you recognize why semantic sets can impede learning? If you cannot confidently address these concepts, review the relevant sections.
\end{tcolorbox}
