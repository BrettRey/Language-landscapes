...
\paragraph*{Glottis (11)} The space between the vocal folds is called the glottis. When the vocal folds are brought together abruptly, they produce a \is{glottal stop}glottal stop, heard in expressions like \mention{uh-oh} and other words in various dialects.
...
\begin{figure}[ht]
    ...
    \caption{Are the strawberries red? Despite containing no red pixels, most viewers perceive them as red. Based on a technique by Akiyoshi Kitaoka.}
