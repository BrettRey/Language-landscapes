...
\epigraph{Words vibrate worlds if you listen.}{Selina Boan, \enquote{Minimal Pairs Are Words Holding Hands}}
...
For instance, English is happy to have /sl/ as an onset cluster, as in \textit{slide}, \textit{slap}, \textit{slip}. But it categorically rejects /sl/ as a coda. There are no English words that end with /sl/. Similarly, English allows /nd/ as a coda cluster in words like \textit{hand} and \textit{pond}, but it doesn't allow it as an onset~-- /nda/ and /ndi/ are not well-formed English syllables.
...
This compression is what drives \is{vowel!reduction to schwa}vowel reduction. In unstressed syllables, most vowels collapse toward /ə/~-- the schwa, the most common vowel in English. The word \textit{photograph} /ˈfoʊtəgræf/ has full vowels in its first and last syllables, but when we shift to \textit{photographer} /fəˈtɒgrəfər/, the stress moves and the formerly full vowels reduce. This is not sloppy speech; it's the system working as designed. Learners who give every syllable equal weight sound effortful and choppy, not because their vowels are wrong but because their rhythm is.
...
The stress-timed/syllable-timed contrast is an oversimplification~-- as the chapter noted, it's a continuum, and even ``stress-timed'' English varies by dialect and register. But as a teaching heuristic, it explains a real and pervasive source of difficulty. Rhythm is rarely taught explicitly in pronunciation classes, yet it may matter more for intelligibility than any individual consonant or vowel.
