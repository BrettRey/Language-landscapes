...
This chapter introduces several practical diagnostic techniques for analyzing speech sounds:
\begin{itemize}[noitemsep]
    \item \textbf{Aspiration test} -- Use a tissue or flame to detect the puff of air that distinguishes aspirated consonants like [t\textsuperscript{h}] from unaspirated [t]
    \item \textbf{Voicing test} -- Place fingertips on throat to feel vocal cord vibrations that distinguish voiced from voiceless consonants
    \item \textbf{Vowel length awareness} -- Notice duration differences in vowels before voiced vs voiceless consonants (e.g., \textit{mad} vs \textit{mat})
    \item \textbf{Syllabic ear training} -- Analyze onset-nucleus-coda structure to understand phonotactic constraints
    \item \textbf{Connected speech observation} -- Identify linking, assimilation, and reduction processes in natural speech
\end{itemize}
\end{tcolorbox}
...
\begin{tcolorbox}[title=Practice: Exploring Your Articulators, colback=green!10!white, colframe=green!75!black]
Try these exercises to feel your articulatory organs in action: (1) Say "mama" while holding your nose - notice how nasal sounds are blocked, (2) Alternate between /k/ and /g/ with your hand on your throat - feel the voicing difference, (3) Say /s/ and /ʃ/ (sh) - notice how your tongue position changes the sound quality.
\end{tcolorbox}
...
\begin{tcolorbox}[title=Practice: Vowel Awareness, colback=green!10!white, colframe=green!75!black]
Develop your vowel sensitivity: (1) Slowly say "beat-bit-bet-bat" feeling your tongue height change, (2) Say "boot-book" noticing the lip rounding difference, (3) Practice the diphthong in "ride" - can you feel the tongue movement from /a/ to /ɪ/?
\end{tcolorbox}
...
\begin{tcolorbox}[title=Reflection: Your Pronunciation Philosophy, colback=blue!10!white, colframe=blue!75!black]
Consider your own pronunciation teaching approach: How will you balance intelligibility vs. native-like accuracy? How might your students' goals, contexts, and backgrounds influence your pronunciation priorities? What role should accent bias awareness play in your teaching?
\end{tcolorbox}
...
\begin{tcolorbox}[title=Try the Diagnostic Tests, colback=green!10!white, colframe=green!75!black]
Apply the tests from this chapter: (1) Do the tissue/flame test with "top" vs "stop" - can you detect the aspiration difference? (2) Use the voicing test (fingers on throat) while saying "pat" vs "bat", (3) Try saying Spanish-like [β] between vowels in "very" - does it sound different from English /v/?
\end{tcolorbox}
...
\begin{tcolorbox}[title=Practice: Syllable Analysis, colback=green!10!white, colframe=green!75!black]
Develop your syllabic ear: (1) Break down "strengths" /stɹɛŋkθs/ into onset-nucleus-coda, (2) Explain why "estop" for "stop" reveals Spanish phonotactic influence, (3) Try saying your name with only CV syllables - what vowels get inserted and where?
\end{tcolorbox}
...
\begin{tcolorbox}[title=Check Your Understanding: Suprasegmentals, colback=yellow!10!white, colframe=yellow!75!black]
Practice with suprasegmental features: (1) Say "REcord" (noun) vs "reCORD" (verb) - feel the stress difference, (2) Try "You're going?" with rising vs falling intonation, (3) Tap out the rhythm of "The CAT has EAten the RAT" - notice equal spacing between stressed syllables.
\end{tcolorbox}
...
\begin{tcolorbox}[title=Self-Assessment: Phonetic Competence, colback=yellow!10!white, colframe=yellow!75!black]
Before moving on, check your phonetic awareness: Can you identify places/manners of articulation? Do you understand the phoneme/allophone distinction? Can you analyze syllable structure? Are you aware of connected speech processes? Have you developed realistic pronunciation goals? If you cannot confidently answer yes to these questions, review the relevant sections.
\end{tcolorbox}
\is{connected speech|)}
