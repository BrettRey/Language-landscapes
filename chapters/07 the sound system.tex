...
I have roughly 24 \textsc{consonant} \is{consonant!phonemes, number of}phonemes in my dialect (depending on whether you count things like the glottal stop in \mention{uh-oh}), each characterized by its place and manner of articulation, and voicing. Let's explore these features:
...
\textsc{\is{diphthong|(}Diphthongs} are vowel sounds that involve a change in quality during their production (from Greek \mention{diphthongos} `having two sounds'). For example, \mention{ride} starts at /a/ and ``glides'' to /ɪ/. My dialect includes the following diphthongs.
