...
\begin{quote}
    Can I use \textit{where} instead of \textit{that} in the relative clause in \textit{I wouldn't like to stay in a hotel \emph{that doesn't have air conditioning}.} It seems that, if \textit{where} is used for places and a hotel is a place, then this should be possible. But it sounds ungrammatical.
\end{quote}
...
The compound \textit{-ever} words aren't just possible but common in fused relatives. \textit{What} is also possible, but \textit{while} is not.
