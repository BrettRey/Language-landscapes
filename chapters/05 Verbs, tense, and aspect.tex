...
\begin{description}
\item[auxiliary verb] A special class of verbs with the NICER properties (Negation, Inversion, Contraction, Ellipsis, Rebuttal), including \textit{be}, \textit{have}, \textit{do}, and modal auxiliaries.
...
\item[NICER properties] The five distinctive properties of auxiliary verbs: Negation (direct negation with \textit{not}), Inversion (subject-auxiliary inversion), ``Contraction'' (with \textit{not}), Ellipsis (stranding in VP ellipsis), and Rebuttal (use with \textit{so}/\textit{too}).
...
\item[progressive aspect] An aspectual form using \textit{be} + \textit{-ing} participle that expresses relevance not just to what continues but
...
\item[modal auxiliary] A type of auxiliary verb expressing modality (possibility, necessity, obligation, etc.), including \textit{can}, \textit{may}, \textit{must}, \textit{shall}, \textit{will}, and their inflected forms.
