...
\begin{tcolorbox}[title=Analytical approaches in this chapter, colback=gray!10!white, colframe=gray!75!black]
...
\begin{tcolorbox}[title=Check Your Understanding: The CAF Triangle, colback=yellow!10!white, colframe=orange!75!black]
...
\begin{tcolorbox}[title=Fluency Reflection: Automaticity in Action, colback=yellow!10!white, colframe=orange!75!black]
...
This chapter explored fluency as the flow dimension~-- often overlooked~-- of language proficiency, distinguishing it from overall linguistic competence:

\begin{itemize}[noitemsep]
    \item \textbf{Fluency as flow}: Fluency refers to the ability to process language smoothly and automatically, like a dancer's movement or musician's performance, allowing for errors while maintaining momentum
    \item \textbf{CAF triangle}: Complexity, accuracy, and fluency compete for limited attentional resources; focusing on one dimension necessarily reduces capacity for others
    \item \textbf{Multiple dimensions}: Fluency manifests differently across speaking, listening, reading, and writing
    \item \textbf{Automaticity principle}: Fluent language use involves proceduralized skills that operate below conscious awareness, freeing attention for higher-level communication goals
    \item \textbf{Vocabulary correlation}: Vocabulary knowledge accounts for about 50\% of reading fluency variance, 30--45\% of listening comprehension, and 15\% of speaking fluency
    \item \textbf{Repair patterns}: Hesitations, repetitions, and self-corrections serve as natural coping mechanisms in L2 speech and shouldn't be entirely eliminated
    \item \textbf{Strategic development}: Fluency can be enhanced by temporarily reducing pressure for perfect accuracy and complex structures, allowing focus on flow and automatization
    \item \textbf{Pedagogical balance}: Effective language instruction requires strategic attention to fluency development alongside traditional accuracy and complexity goals
\end{itemize}

Understanding fluency as a distinct but interconnected aspect of language proficiency helps teachers create more balanced curricula that value communicative flow alongside grammatical precision and linguistic sophistication.
