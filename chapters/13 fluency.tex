...
This chapter explored fluency as the flow dimension of language proficiency, distinguishing it from overall linguistic competence:
...
\begin{itemize}[noitemsep]
    ...
    \item \textbf{Multiple dimensions}: Fluency manifests differently across speaking (smooth delivery), listening (real-time processing), reading (effortless comprehension), and writing (sustained production)
    ...
    \item \textbf{Vocabulary correlation}: Vocabulary knowledge accounts for approximately 50\% of reading fluency variance, 30-45\% of listening comprehension, and 15\% of speaking fluency
