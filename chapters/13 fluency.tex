...
\begin{itemize}[noitemsep, leftmargin=*]
    \item \textbf{CAF Triangle Analysis} -- Understanding how complexity, accuracy, and fluency compete for limited attentional resources
    \item \textbf{Flow vs. Proficiency} -- Distinguishing between smooth language processing and overall language knowledge
    \item \textbf{Temporal Measures} -- Using speech rate, pause patterns, and hesitation markers to assess fluency
    \item \textbf{Cross-skill Comparison} -- Examining how fluency manifests differently in speaking, listening, reading, and writing
    \item \textbf{Repair Analysis} -- Understanding how self-corrections and reformulations function in language production
\end{itemize}
...
\toprule
 & \emph{\textbf{Fluent}} & \emph{\textbf{Proficient}} \\
\midrule
