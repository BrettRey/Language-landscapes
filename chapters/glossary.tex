...
\item[allophone] A variant of a phoneme that doesn't change meaning in a given language. For example, the aspirated [t\textsuperscript{h}] in \mention{top} and unaspirated [t] in \mention{stop} are allophones of /t/ in English.
