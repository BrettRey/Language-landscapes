...
\item[adverb phrase (AdvP)] A phrase headed by an adverb. Functions primarily as modifier of verbs, adjectives, other adverbs, clauses, and PPs. Rarely functions as complement. Accepts degree modifiers like \mention{very}, \mention{too}, \mention{so} but not \mention{right}, \mention{straight}, \mention{just} (in Standard English).
