...
\item[adverb phrase (AdvP)] A phrase headed by an adverb. Functions primarily as a modifier of verbs, adjectives, other adverbs, clauses, and PPs. Rarely functions as a complement. Accepts degree modifiers like \mention{very}, \mention{too}, \mention{so} but not \mention{right}, \mention{straight}, \mention{just} (in Standard English).

\item[affixal negation] Negation expressed through prefixes (like \mention{un-}, \mention{dis-}, \mention{non-}) or suffixes attached to words rather than through separate negative words.
...
\item[allophone] A variant of a phoneme that doesn't change meaning in a given language. For example, the aspirated [tʰ] in \mention{top} and unaspirated [t] in \mention{stop} are allophones of /t/ in English.

\item[assimilation] A process in connected speech where a sound becomes more like a neighbouring sound. For instance, \mention{ten books} may be pronounced as [tem b\textupsilon ks].
...
\item[auxiliary verb] A verb that carries tense, aspect, or modality (e.g., \mention{be}, \mention{have}, \mention{do}, \mention{can}, \mention{will}) and has the NICER properties: Negation, Inversion, Contraction, Ellipsis, and Rebuttal.

\item[clause] A grammatical structure headed by a verb phrase and usually containing a subject.

\item[clausal negation] Negation that applies to an entire clause, subdivided into verbal negation (using \mention{not} with verbs) and non-verbal negation (using \mention{not} with other constituents).
...
\item[coda] The consonant(s) following the (vowel) nucleus in a syllable. In \mention{cat} /k\ae t/, /t/ is the coda.

\item[complement selection] The more-or-less arbitrary requirement that certain words license specific prepositions as complements (e.g., \mention{depend on}, \mention{interested in}, \mention{proud of}). A major challenge for language learners.
...
\item[defective verb] A verb lacking one or more of the typical verb forms (e.g., \mention{must}, which has no past tense).
...
\item[dependent] A phrase that depends on the head. For example, \mention{the} is a dependent in \mention{the cake}.
...
\item[determinative] A word of the lexical category that typically specifies the reference and number of noun phrases, including articles (\mention{the}, \mention{a}), demonstratives (\mention{this}, \mention{that}), and quantifiers (\mention{some}, \mention{many}), distinguished from adjectives by their function and distribution.

\item[determinative phrase (DP)] A phrase headed by a determinative that mostly functions as the determiner in an NP, such as \mention{most}, \mention{not many}, \mention{almost every}, and \mention{just about all}.
...
\item[fallacy of monosemy] The mistaken belief that words have (or should have) only one ``true'' meaning.
...
\item[gradability] The property of adjectives, adverbs, and some determinatives and prepositions that allows them to be modified by degree words like \mention{very}, \mention{quite}, or \mention{extremely}, and to form comparative and superlative forms.
...
\item[head] The word in a phrase that determines the phrase's grammatical type. \mention{Cake} is the head of the NP \mention{the chocolate cake}; \mention{tall} is the head of the AdjP \mention{very tall}.

\item[indirect object] A constituent that precedes the direct object and typically represents the recipient or beneficiary of an action, often paraphraseable with \mention{to} or \mention{for} phrases.
...
\item[Jespersen's cycle] A historical process describing how negation markers evolve and change in languages, named after Otto Jespersen. English evolved from Old English \mention{ne} through stages of reinforcement to modern contracted forms like \mention{don't}.
...
\item[linking] The connection of sounds across word boundaries in connected speech, as in \mention{an apple}.
...
\item[modal auxiliary] A type of auxiliary verb expressing meanings like possibility, necessity, or future time (e.g., \mention{can}, \mention{must}, \mention{will}).

\item[modality] The expression of meanings such as possibility, necessity, permission, and obligation.

\item[modification test] Diagnostic for distinguishing PPs from AdvPs: PPs generally accept \mention{right}, \mention{straight}, \mention{just} as modifiers; AdvPs generally accept \mention{very}, \mention{too}, \mention{so}.
...
\item[negative polarity item] A word or phrase (like \mention{any}, \mention{ever}, \mention{yet}, \mention{at all}) that typically appears only in negative contexts or other downward-entailing environments.
...
\item[noun] A word that can head a noun phrase. Nouns can typically be singular or plural, follow determiners like \mention{the} and \mention{a}, and take AdjP modifiers. They can denote almost anything (entities, actions, states, concepts), which is why denotation alone can't define them.

\item[noun phrase (NP)] A phrase headed by a noun or pronoun, typically functioning as a subject, object, predicative complement, or complement of a preposition.

\item[noun, count / non-count] Often called countable / uncountable. A count noun allows counting and plural marking (\mention{1 book}, \mention{2 ideas}); a non-count noun doesn't (*\mention{1 furniture}, *\mention{2 groceries}). The distinction involves both a semantic construal (whether the referent is seen as individuated) and a grammatical marking (whether the noun takes plural and numeral dependents).

\item[NP-complement view] The traditional (but problematic) view that defines prepositions as words that must take NP complements. Creates unnecessary complexity by forcing words like \mention{before} into three different categories.

\item[nucleus] The core of a syllable, typically a vowel. In \mention{cat} /k\ae t/, /\ae/ is the nucleus.

\item[onset] The consonant(s) preceding the nucleus in a syllable. In \mention{cat} /k\ae t/, /k/ is the onset.
...
\item[particle] A preposition functioning as part of a phrasal verb that can appear either before or after an NP object (\mention{pick up the pen}/\mention{pick the pen up}) but must follow pronoun objects (\mention{pick it up}, not *\mention{pick up it}).

\item[participle] A non-tensed verb form, either present participle (\mention{-ing} form) or past participle (typically \mention{-ed} or irregular forms), used in various constructions including progressive and perfect aspects.

\item[perfect aspect] An aspectual form using \mention{have} + past participle that relates a situation to a later reference point, often expressing some relevance to that reference point.

\item[phoneme] The smallest unit of sound that can distinguish meaning in a language. Changing /b/ to /p/ turns \mention{bat} into \mention{pat}.

\item[phonotactics] The rules governing possible sound combinations in a language. English allows /sl/ as an onset (e.g., \mention{slide}) but not as a coda.

\item[phrase] A grammatical structure consisting of a head word and any optional dependents. The head determines the phrase's type: an NP is headed by a noun, a VP by a verb. A phrase can be a single word (\mention{Stop!} is a VP).
...
\item[phrasal verb] A verb + preposition(s) combination that often expresses idiomatic meaning (e.g., \mention{give up}, \mention{look up}, \mention{take off}). The preposition may function as a particle that can move around NP objects but not pronoun objects.
...
\item[positive polarity item] A word or phrase (like \mention{some}, \mention{already}, \mention{a fair chance}) that resists appearing in negative contexts and prefers positive or affirmative environments.
...
\item[predicative complement] A phrase that follows verbs like \mention{be}, \mention{seem}, \mention{become}, \mention{remain}, \mention{look}, and \mention{feel} and that describes or identifies the subject (or, with some verbs, the object).

\item[predicative complement test] Diagnostic showing that PPs (but not AdvPs) can function as complement after verbs that license predicative complements: \mention{The meeting is at noon} but not *\mention{The meeting is quickly}.

\item[preposition fronting] Fronting an entire PP in an interrogative or relative, typically in formal contexts: \mention{About what did you disagree?} versus the more common stranded version \mention{What did you disagree about?}

\item[preposition phrase (PP)] A phrase headed by a preposition. Functions as both modifier and complement in various phrase types. Can modify nouns (unlike AdvPs) and frequently serves as predicative complement after \mention{be}, \mention{seem}, \mention{remain}.
...
\item[progressive aspect] An aspectual form using \mention{be} + \mention{-ing} participle that expresses relevance not just to what continues but to its eventual conclusion.

\item[reduction] The weakening or omission of sounds in connected speech, often in unstressed syllables. For example, \mention{going to} may be pronounced as \mention{gonna}.
...
\item[verb] A word that can head a verb phrase. Most verbs have a past-tense form, an \mention{-s} form, an \mention{-ing} form, and a plain form. They typically denote actions or states, but this is a tendency, not a definition; \mention{existence} is a noun and \mention{resemble} is a verb.

\item[verb phrase (VP)] A phrase headed by a verb, potentially including modifiers and complements. Can be modified by adverb phrases but not adjective phrases.
