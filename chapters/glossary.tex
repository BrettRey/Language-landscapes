...
\item[dependent] A phrase that depends on the head. For example, \mention{the} is a dependent in \textit{the cake}.
...
\item[determinative phrase (DP)] A phrase headed by a determinative that mostly functions as the determiner in an NP, such as \mention{most}, \textit{not many}, \textit{almost every}, and \textit{just about all}.
...
\item[head] The word in a phrase that determines the phrase's grammatical type. \mention{Cake} is the head of the NP \textit{the chocolate cake}; \mention{tall} is the head of the AdjP \textit{very tall}.
...
\item[reduction] The weakening or omission of sounds in connected speech, often in unstressed syllables. For example, \textit{going to} may be pronounced as \mention{gonna}.
