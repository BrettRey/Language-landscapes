...
\item Determiners like \emph{the}, \emph{a}, \emph{this}, and \emph{some} are function words that specify reference properties of nouns and form a closed grammatical class
\item Direct objects are noun phrases that complete the meaning of transitive verbs and can be identified through passivization and cleft construction tests
\item Indirect objects precede direct objects and can be paraphrased with \emph{to} or \emph{for} phrases, representing recipients or beneficiaries of actions
...
\item Complements are required constituents that complete the meaning of heads and cannot be deleted without causing ungrammaticality
...
\item[direct object] A noun phrase that completes the meaning of a transitive verb and can be identified through passivization tests (becomes the subject in passive constructions).

\item[indirect object] A noun phrase that precedes the direct object and typically represents the recipient or beneficiary of an action, often paraphraseable with \emph{to} or \emph{for} phrases.

\item[predicative complement] A phrase that follows linking verbs and provides essential information about the subject or object, completing the predicate's meaning.

\item[object complement] A phrase that follows and describes or renames the direct object in complex-transitive constructions.

\item[modifier] A dependent that provides additional descriptive information about its head and can typically be deleted without affecting grammatical acceptability.

\item[complement] A required dependent that completes the meaning of its head and cannot be deleted without causing ungrammaticality.

\item[determinative] A word or phrase that specifies reference properties of nouns, including articles, demonstratives, and quantifiers like \emph{the}, \emph{this}, and \emph{some}.
...
\item[resultative construction] A syntactic pattern where a verb is followed by a result phrase describing the outcome of the action (e.g., \emph{hammer the metal flat}).
