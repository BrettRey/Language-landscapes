...
\ea
\begin{dialogue}
\item[Me] \textit{What do you mean? What did people used to think about dinosaurs?}
\item[Student] \textit{They think they crawl like} [demonstrates with hand movement]
\item[Me] \textit{They thought they walked like this?} [imitates movement]
\item[Student] \textit{Yes, like, like, uh gecko. But now they think more like bird.}
\item[Me] \textit{Right, I see, more like birds. Standing upright.}
\end{dialogue}
\z
