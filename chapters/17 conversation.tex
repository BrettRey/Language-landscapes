...
\begin{tcolorbox}[title=Exercise: Mapping Temporal Layers, breakable, colback=white, colframe=blue!75!black, fonttitle=\bfseries]
...
\begin{tcolorbox}[title=Exercise: Cultural Patterns in Action, breakable, colback=white, colframe=red!75!black, fonttitle=\bfseries]
...
\begin{tcolorbox}[title=Observation Exercise: Grounding in Action, colback=yellow!10!white, colframe=orange!75!black]
...
\begin{tcolorbox}[title=Exercise: Tracking Common Ground, breakable, colback=white, colframe=purple!75!black, fonttitle=\bfseries]
...
\begin{tcolorbox}[title=Exercise: Grammar as Real-Time Resource, breakable, colback=white, colframe=green!75!black, fonttitle=\bfseries]
...
\begin{tcolorbox}[title=Exercise: Bodies and Space, breakable, colback=white, colframe=orange!75!black, fonttitle=\bfseries]
...
\begin{tcolorbox}[title=Exercise: Digital Transformations, breakable, colback=white, colframe=teal!75!black, fonttitle=\bfseries]
...
\begin{tcolorbox}[title=Quick Self-Check: Conversation Analysis Skills, colback=yellow!10!white, colframe=orange!75!black]
...
This chapter explored conversation as a complex, self-organizing system that emerges from real-time coordination between participants:

\begin{itemize}[noitemsep]
    \item \textbf{Multi-timescale organization}: Conversation operates simultaneously on different scales, from microsecond adjustments to extended sequences and activities, with patterns emerging at each level
    \item \textbf{Cultural turn-taking variation}: Overlapping speech, sequential turns, and contrapuntal conversation reflect different cultural models of interaction coordination
    \item \textbf{Collaborative grammar}: Structures like if-then constructions create natural pivot points for speaker transitions, enabling real-time collaborative completion
    \item \textbf{Topic management}: Topic transitions emerge organically through linking practices, transformations, and activity-type cues rather than explicit announcements
    \item \textbf{Turn-constructional units}: Speakers recognize completion points through grammatical, prosodic, and pragmatic cues, enabling precise timing coordination
    \item \textbf{Common ground construction}: Participants work to establish shared understanding through back-channels, confirmation checks, grounding practices, and repairs
    \item \textbf{Embodied interaction}: Precisely timed gestures, spatial arrangements, and visual displays are fundamental to meaning-making, not mere add-ons to verbal communication
    \item \textbf{Action sequences}: Conversations accomplish social actions through adjacency pairs and extended sequences where each turn creates conditional relevance for responses
    \item \textbf{Knowledge co-construction}: Understanding emerges from stance-taking, inference-making, and interpretive work rather than simple information transfer
    \item \textbf{Face and power dynamics}: Social relationships, politeness concerns, and institutional contexts shape conversational possibilities and constraints
    \item \textbf{Side-sequence management}: Participants regularly suspend main activities for clarifications, repairs, and other concerns while maintaining overall coherence
    \item \textbf{Digital adaptation}: Text-based communication develops new turn-taking patterns, repair strategies, and multimodal resources while preserving core conversational principles
\end{itemize}
...
\begin{tcolorbox}[title=Exercise: Synthesis—Conversation as System, breakable, colback=white, colframe=black!75!black, fonttitle=\bfseries]
