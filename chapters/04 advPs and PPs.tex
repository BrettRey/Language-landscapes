...
\item[preposition stranding] When a preposition appears without its complement because the complement has been fronted, as in questions (\textit{What are you looking \uline{at}?}) or relative clauses (\textit{the person you spoke \uline{to}}).
