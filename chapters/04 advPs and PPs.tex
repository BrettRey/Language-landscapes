...
\begin{itemize}[noitemsep]
   ...
   \item in PPs: \textit{He lives \emph{right} in the city center}. \textit{She sat \emph{just} behind the curtain}
...
\mention{put on}, \mention{look up}, \mention{come across}, and \mention{turn down}.\footnote{\textit{CGEL} \citep{Huddleston2002} eschews the term \term{phrasal verbs} in favor of \term{prepositional verbs}.} These expressions consist of a verb
